...
-- 1. 정수형 타입
--	 NUMBER(숫자 자릿수) : 자릿수는 바이트가 아니고 표시되는 숫자의 자리수
--	 NUMBER(2) -99 ~ 99
...
-- 4. 고정형 문자(chleo 2000 Byte)
--	 char( XX )
--	 char(10)에 "abcd"를 저장하면 "abcd      " 가 저장(공백포함)
...
--	 SYSTIMESTAMP : TIMESTAMP 형식의 오늘날짜 현재시간(밀리초 포함)을 발생시키는 키워드
